...
const AboutPage = () => {
  ...
  const Q_A_TEXT = (
    <div>
      ...
      <div>
        <label className={styles.bold2}>What was learned in the development process?</label>
        <div>
      ...
      <div>
        <label className={styles.bold2}>What were the biggest struggles?</label>
        <div>
      ...
      <div>
        <label className={styles.bold2}>What are the plans for future improvements?</label>
        <div>
  ...
  return (
    <div className={styles.aboutPageContainer}>
      ...
      <h1 className={styles.pageTitle}>About Cost</h1>
